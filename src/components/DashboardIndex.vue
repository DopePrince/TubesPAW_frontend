                ...
                <v-row>
                    <v-col v-for="n in 3" :key="n" cols="12" md="4">
                        <v-card :loading="loading" class="mx-auto my-12" max-width="374">
                            <v-img height="250"
                                src="https://teknokreatips.com/wp-content/uploads/2022/04/apa-itu-web-development.jpg"></v-img>
                            ...
                            <v-card-text>
                                ...
                                <div class="my-4 text-subtitle-1">
                                    ...
                                    involved in Web development. The most common languages used
                                    to create web pages are HTML, CSS, JavaScript, and PHP.
                                </div>
                            </v-card-text>
